...
from models.multimodal_bart.mixins import FromPretrainedMixin
...
class MultiModalBartForConditionalGeneration(FromPretrainedMixin, BartPretrainedModel): #GenerationMixin in the middle
